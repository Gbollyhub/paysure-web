...
<img class="img-fluid image" src="../assets/images/home-bkg.png" />
</div>
<div class="col-lg-3 col-sm-12 side-bar">
<div class="container ">
  <div class="row" style="flex-direction:column">
      ...
      <div class="mt-3">
                <div class="card card-hover">
                  ...
                  <h4 class="card-headers">Buy Airtime</h4>
                  <div class="card-body">
               ...
               <div class="mt-3">
                <div class="card card-hover">
                  <div class="card-icon">
                    <span class="span-icon">
                   <img src="../assets/images/svg3.svg"/>
                    </span>
                  </div>
                  <h4 class="card-headers">Transfer Money</h4>
                  <div class="card-body">
                    Gain valuable tips and hacks you need to create an appealing
                    resume and navigate interview scenarios.
                  </div>
               ...
               <div class="mt-3">
                <div class="card card-hover">
                  <div class="card-icon">
                    <span class="span-icon">
                   <img src="../assets/images/svg2.svg"/>
                    </span>
                  </div>
                  <h4 class="card-headers">Pay Bills</h4>
                  <div class="card-body">
                    Gain valuable tips and hacks you need to create an appealing
                    resume and navigate interview scenarios.
                  </div>
...
<img class="img-fluid image" src="../assets/images/home-bkg12.png" />
</div>
...
<div class="col-lg-8 col-sm-12">
<img class="img-fluid image" src="../assets/images/iPhone.png" />
</div>
<div class="col-lg-4">
<h1>
  The Paysure App
...
<div class="app-icons">
  ...
  <i class="fab fa-apple app-icon ml-3"></i>
</div>
</div>
  </div>
...
<section class="mt-5" id="becomeAgent">
<div class="container">
  <div class="row mt-5" style="align-items:center">
<div class="col-lg-5">
<h1>
...
<div class="mt-3">
<nuxt-link @click.native="scrollToTop()" to="becomeAgent" tag="button" class="btn-home mt-3">
  Learn More
</nuxt-link></div>
</div>
<div class="col-lg-7 col-sm-12">
<img class="img-fluid image" src="../assets/images/home-bkg3.png" />
</div>
...
<button class="btn-home mt-3" style="background-color:#fff!important;color:var(--primary-color)">
  Get In Touch
</button>
</div>
<div class="col-lg-7 col-sm-12">
<img class="img-fluid image" src="../assets/images/home-bkg4.png" />
</div>
...
<section id="contact">
  ...
  <div class="form-group mt-3">
    ...
    <textarea type="text" class="form-control" id="formGroupExampleInput" placeholder="" style="height:140px"/>
  </div>
...
section{
  ...
  position: relative;
  background:url(../assets/images/app-bck.svg);
